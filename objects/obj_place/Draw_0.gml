...
if global.current_layer == 2
{
	...
	if mouse_check_button_pressed(global.controls[0])
	{
		...
		object_data_index[array_length] = palette_conversion[obj_objects.last_selection];
...
{
	current_sprite = palette_conversion[obj_objects.current_sprite];
	current_index = palette_conversion[obj_objects.last_selection];
