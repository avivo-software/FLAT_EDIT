...
action_id = 1; // describes the type of palette | 1 = Slides

last_selection = 0; // Stores ID of last selected sprite

current_sprite = spr_backgrounds_colour; // Determines the currently selected sprite
primary_sprite = spr_backgrounds_colour; // Determines primary sprite
secondary_sprite = spr_backgrounds_grey; // Determines secondary sprite
...
secondary_x_scale = 0.124; // Determines the secondary X scale
secondary_y_scale = 0.124; // Determines the secondary Y scale
...
stuck[0] = true; // Sets default selection
