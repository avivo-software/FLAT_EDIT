...
current_sprite = spr_backgrounds_grey; // Determines the currently selected sprite
primary_sprite = spr_backgrounds_grey; // Determines primary sprite
secondary_sprite = spr_backgrounds_colour; // Determines secondary sprite
